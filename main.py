...
async def extract_text(file: UploadFile = File(...)):
    ...
    try:
        ...
        ▶ [CABIN LOG 인 경우]
        1. 🚨 NEF 강제 확정 (MEL 오독 절대 금지): 'DEFER No.' 칸에 적힌 번호가 **'XX-XX-XX' (예: 23-30-12 등 오직 6자리 숫자와 대시 기호)** 형태라면 ➡️ 100% "NEF"입니다. 이 경우 "MEL"로 잘못 출력하는 것을 엄격히 금지합니다! 그리고 AMM 으로도 출력하면 안됩니다. AMM 에 옆에 붙어 있다고 AMM 이 아닙니다. 꼭 양식을 보고 NEF 로 판단하길바랍니다.
