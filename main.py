...
async def extract_text(file: UploadFile = File(...)):
    ...
    try:
        ...
        - 다음은 CABIN LOG 의 경우에 해당합니다. 
        - 💡 공식 1: 만약 텍스트가 'MEL X NEF' 처럼 인식된다면 ➡️ X는 무조건 왼쪽 단어의 것이므로, 절대 NEF가 아니라 100% **MEL** 입니다!
        - 💡 공식 2: 만약 텍스트가 'NEF X AMM' 처럼 인식된다면 ➡️ 무조건 **NEF** 입니다!
        - 💡 공식 3: 만약 텍스트가 'AMM X' 처럼 인식된다면 ➡️ 무조건 **AMM** 입니다!
